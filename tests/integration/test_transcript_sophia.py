...
CLINICIAN_TURNS = [
    ...
    (
        ...
        "With that in mind, are you feeling ready for us to go ahead with Sophia’s vaccines today?"
    ),
]
...
PARENT_REPLIES = [
    ...
    # Turn 11 (Extra)
    "Okay, yes. I'm still a bit nervous, but knowing I'll have that information and can call if I need to helps a lot. I want to do what's best for Sophia, so let's go ahead.",
]
