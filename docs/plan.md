...
- Enable APIs in your-project-id:
...
- Service Accounts and IAM:
  - Runtime SA (Cloud Run): cr-vertex-runtime@your-project-id.iam.gserviceaccount.com
  - Grant minimal roles to runtime SA:
    - roles/aiplatform.user
    - roles/logging.logWriter
    - roles/monitoring.metricWriter
  - Deploy (CI/CD) SA for WIF: cr-deployer@your-project-id.iam.gserviceaccount.com
    - Roles:
      - roles/run.admin
...
- Required GitHub repo secrets/variables:
  - GCP_PROJECT_ID=your-project-id (secret or variable)
  ...
  - WORKLOAD_SA=cr-deployer@your-project-id.iam.gserviceaccount.com (secret)
...
- Image path example:
  - us-west4-docker.pkg.dev/your-project-id/cr-demo/gemini-flash-demo:$GIT_SHA
...
- Assumptions:
  - us-west4 supports the public alias gemini-1.5-flash for text generation.
...
- deploy-notes.md with concrete gcloud commands for your-project-id.
