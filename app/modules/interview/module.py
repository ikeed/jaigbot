        ...
        payload = SessionBootstrapPayload(
            ...
            artifacts=(
                StartupArtifact(
                    ...
                    metadata={"audience": "candidate", "presentation": "primary"},
                ),
                StartupArtifact(
                    kind="interview_guidance",
                    title="Response Guidance",
                    content="Use a STAR-style answer and be concrete about outcomes.",
                    metadata={"audience": "candidate", "presentation": "inline"},
                ),
            ),
